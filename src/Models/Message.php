...
use BombenProdukt\Conversations\Database\Factories\MessageFactory;
use BombenProdukt\Conversations\Models\Concerns\HasSchemalessAttributes;
...
/**
 * BombenProdukt\Conversations\Models\Message
 *
 * @property \Eloquent|Model                                       $author
 * @property null|\BombenProdukt\Conversations\Models\Conversation $conversation
 *
 * @method static \BombenProdukt\Conversations\Database\Factories\MessageFactory factory($count = null, $state = [])
